...
if ($ADMIN->fulltree) {
    ...
    $name = 'theme_ben/preset';
    $title = get_string('preset', 'theme_ben');
    $description = get_string('preset_desc', 'theme_ben');
    ...
    $fs = get_file_storage();
    $files = $fs->get_area_files($context->id, 'theme_ben', 'preset', 0, 'itemid, filepath, filename', false);
    ...
    $name = 'theme_ben/presetfiles';
    $title = get_string('presetfiles','theme_ben');
    $description = get_string('presetfiles_desc', 'theme_ben');
